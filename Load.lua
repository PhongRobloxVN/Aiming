return function(Type, PatchName)
    ...
    -- // Vars
    local PatchFormat = "https://raw.githubusercontent.com/PhongRobloxVN/Aiming/main/GamePatches/%s/%s.lua"
    ...
    if (not Success) then
        local ModuleFormat = "https://raw.githubusercontent.com/PhongRobloxVN/Aiming/main/%s.lua"
